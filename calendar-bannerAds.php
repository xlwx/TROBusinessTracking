	  ...
	  <div class="row placeholders">
			<div class="col-md-4">
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon1">Banner Ads</span>
					<select id="bannerAds" name ="bannerAds" class="form-control selectpicker" aria-describedby="basic-addon1" data-live-search="true">
...
<?
	...
	$name = 'bannerName';
	$data = "'bannerID='+id;";
	$htmlItem = 'bannerAds';  // This is the id of the selection item in html
