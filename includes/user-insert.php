...
$db->execute();
$salesMemberID = $db->lastInsertId();

$sql = "INSERT INTO User (UserName,Password,SalesMemberID,Admin) VALUES (:username,:password,:salesMemberID,:admin)";
$db->query($sql);
$db->bind(":username", $_POST['username'], PDO::PARAM_STR);
$pass = $_POST['pass'];
$pass = md5($pass);
$db->bind(":password", $pass, PDO::PARAM_STR);
$db->bind(":salesMemberID", $salesMemberID, PDO::PARAM_STR);
$db->bind(":admin", 'no', PDO::PARAM_STR);
$db->execute();
