...
$calendarId = 'qfs82hden519fnit1n3leia1ok@group.calendar.google.com';
...
$sql = "INSERT INTO travelAgentSpotlight (Name,SupplierID,BannerType,StartDate,EndDate,BannerCode,GoogleCalId,AdId) VALUES (:name,:supplierID,:bannerType,:startDate,:endDate,:bannerCode,:googleCalId,:AdId)";
$db->query($sql);
...
header("Location:".BASE_URL."travelAgentSpotlight-list.php");
exit;
?>
